...
# Initialize the ARCH model
model = arch_model(train_data['demand'], mean='AR', vol='GARCH', p=1, o=1, q=1)
...
# Fit the ARCH model with the best hyperparameters
best_model = arch_model(train_data['demand'], mean='AR', vol='GARCH', p=best_params['p'], o=best_params['o'], q=best_params['q'])
best_model_fit = best_model.fit()

# Forecast demand using the fitted ARCH model
